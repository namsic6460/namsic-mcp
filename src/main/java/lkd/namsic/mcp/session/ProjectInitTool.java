...
public class ProjectInitTool {
    ...
    @Tool(name = "project_init", description = "Initialize a project-scoped session. "
        + "Returns a UUID sessionId that MUST be passed to every subsequent browser_*, dev_server_* "
        + "and android_* tool call. "
    ...
    public String projectInit(
        ...
        return "sessionId: " + project.sessionId() + '\n'
            ...
            + "Pass this sessionId to every browser_*, dev_server_* and android_* tool call in this conversation. "
